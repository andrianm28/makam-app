...
final class CemeteryDirectoryIndexRouteTest extends TestCase
{
    ...
    public function test_the_page_survives_the_cemeteries_table_being_unreadable(): void
    {
        ...
        // → `cemetery_blocks`, each before its parents. P5a pre-need tables
        // (16 Aug 2026) come first of all: `pre_need_consultation_requests`
        // FK-references `pre_need_interests` (nullable, nullOnDelete), so it
        // must precede that table below; `pre_need_payment_schedules`
