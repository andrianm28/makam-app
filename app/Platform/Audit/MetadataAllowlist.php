...
final class MetadataAllowlist
{
    ...
    public const array ALLOWED_KEYS = [
        ...
        // Non-secret, non-identifying labels/counts — never a code, secret,
        // or recovery code value, per requirements.md's Negative criteria
        ...
        // attempt used ('totp' | 'recovery_code'), never the submitted
        // code itself.
        'method',
