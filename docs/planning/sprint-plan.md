...
Not deployed: S4-T4/S4-T5 (booking wizard) remain paused/uncommitted from 26 Jul. Not deployed: S4-T6/S4-T7/S4-T8 (cemetery directory, renewal, marketplace) — in progress via an agent team as of this entry, not yet committed; this deployment is Batch 0 plus the dependency fix only.
...
- [ ] Booking Steps 1–5 navigable; back preserves data; autosave verified across a session boundary — S4-T4/S4-T5 paused mid-build, nothing committed yet
