...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // DB-05 (batch M3a): the schema change above (nullable columns) is
        // safe to run everywhere and always runs. The DATA below — the
        // fabricated vendor names/prices this migration is named for — ran
        // completely unguarded before this fix, on EVERY `php artisan
        // migrate` including a real production deploy. Guarded the same way
        // as every other fixture migration in this family: see
        ...
        if (! config('example_data.seed_dummy_vendor_pricing_and_photo')) {
            return;
        }
