...
| AC15 | Confirmation-snapshot variables (operator contact, required-document names) allowlisted for customer confirmation templates | none yet | Open — added 19 Sep 2026 from the PRD reconciliation; not started |
