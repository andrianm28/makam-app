...
| AC13 | Progress, cancellation, and retry state contract | `tests/Feature/DocumentVault/DocumentStateViewTest.php`; `tests/Feature/DocumentVault/UploadDocumentTest.php` | Blade state contract and server-side resume enforcement covered; consuming Livewire/browser cancellation, retry, and parent-draft preservation NOT TESTED |
