...
# Makam.co.id — Product Steering

Part of the v0.6 steering set (split from the former monolithic `project.md` on 25 Jul 2026 to match Kiro's documented multi-file convention — see `governance.md` for the split rationale and file map). Product/domain canon:
