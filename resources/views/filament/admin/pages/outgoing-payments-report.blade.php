{{--
    resources/views/filament/admin/pages/outgoing-payments-report.blade.php

    View for App\Filament\Admin\Pages\OutgoingPaymentsReport. Same
    component, money-formatting, and required-states conventions as
