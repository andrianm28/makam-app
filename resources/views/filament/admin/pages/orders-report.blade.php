{{--
    resources/views/filament/admin/pages/orders-report.blade.php

    View for App\Filament\Admin\Pages\OrdersReport. Same component and
    layout choices as finance-reports.blade.php (see that view's own doc
    block): Filament's own Blade components, money/count columns
    right-aligned with `tabular-nums`, a TOTAL row in `font-bold`, and the
    same five required states (§6): loading, empty, validation error,
    success, and support copy for the export.
