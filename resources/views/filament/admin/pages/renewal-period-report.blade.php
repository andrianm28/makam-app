{{--
    resources/views/filament/admin/pages/renewal-period-report.blade.php

    View for App\Filament\Admin\Pages\RenewalPeriodReport. Same component
    and required-states conventions as finance-reports.blade.php.
