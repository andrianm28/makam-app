{{--
    resources/views/livewire/admin/reports/receipts-report-panel.blade.php

    View for App\Livewire\Admin\Reports\ReceiptsReportPanel — the "Laporan
    Penerimaan" tab inside App\Filament\Admin\Pages\Reports. Content moved
    verbatim from the former receipts-report.blade.php (the standalone
    ReceiptsReport Filament page); only the outer <x-filament-panels::page>
