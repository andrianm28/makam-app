{{--
    resources/views/livewire/admin/reports/vendor-performance-report-panel.blade.php

    View for App\Livewire\Admin\Reports\VendorPerformanceReportPanel — the
    "Laporan Kinerja Vendor" tab inside App\Filament\Admin\Pages\Reports.
    Content moved verbatim from the former
    vendor-performance-report.blade.php (the standalone
    VendorPerformanceReport Filament page); only the outer
